 ...
 */
public class StaggeredGridView_bak1 extends ExtendableListView {
    ...
    public StaggeredGridView_bak1(final Context context) {
        this(context, null);
    }

    public StaggeredGridView_bak1(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StaggeredGridView_bak1(final Context context, final AttributeSet attrs, final int defStyle) {
